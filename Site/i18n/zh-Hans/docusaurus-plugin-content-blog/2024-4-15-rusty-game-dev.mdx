...
<p align="center">
  <img src='/img/rusty-zh-0.jpg' alt="在 macOS 上运行的 Dora SSR v1.3.17 版本"/>
...
<p align="center">
  <img src="/img/rusty-zh-1.jpg" alt="在浏览器中访问 Dora SSR 的 Web IDE 并新建文件夹"/>
...
<p align="center">
  <img src='/img/rusty-zh-2.jpg' alt="通过 Web IDE 上传文件，相比用辅助脚本操作可能要更方便"/>
...
<p align="center">
  <img src='/img/rusty-3.jpg' alt="使用脚本完成一键编译、上传和开始运行"/>
   使用脚本完成一键编译、上传和开始运行
</p>
