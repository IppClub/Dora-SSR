...
| anchorA | Vec2 | The position of the anchor point on the first body in world coordinates. |
| anchorB | Vec2 | The position of the anchor point on the second body in world coordinates. |
