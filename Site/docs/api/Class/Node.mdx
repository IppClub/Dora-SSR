...
&emsp;&emsp;The bounding box of the node as a Rect object.
...
| order | integer | The drawing order of the child node. Default is 0. |
| tag | string | The tag of the child node. Default is an empty string. |
...
| order | integer | The drawing order of the current node. Default is 0. |
| tag | string | The tag of the current node. Default is an empty string. |
...
&emsp;&emsp;Schedules a function to run every frame.
...
| Parameter | Type | Description |
| --- | --- | --- |
| func | function | The function to run, return true to stop. |
...
&emsp;&emsp;Schedules a coroutine to run.
...
| Parameter | Type | Description |
| --- | --- | --- |
| job | Routine.Job | The coroutine to run, return or yield true to stop. |
...
&emsp;&emsp;Unschedules the current node's scheduled function or coroutine.
...
| --- | --- | --- |
| worldPoint | Vec2 | The point to convert. |
| z | number | The z-coordinate of the point. Default is 0. |
...
| padding | number | The amount of padding to use between each child node (default is 10). |
...
| Parameter | Type | Description |
| --- | --- | --- |
| enabled | boolean | Whether to enable or disable the grabber. Default is true. |

**Returns:**

| Return Type | Description |
| --- | --- |
| Grabber | A Grabber object when enabled. |
