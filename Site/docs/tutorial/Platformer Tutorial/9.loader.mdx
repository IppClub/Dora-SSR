...
Now we can start writing the processing function for loading the Excel file, which will be executed using the [Content:loadExcel()](../../api/Class/Content#loadexcel) function.
