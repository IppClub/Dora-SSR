...
Firstly, we need to import the [Platformer](../../api/Module/Platformer) and [Data](../../api/Class/Platformer/Data) modules. The Platformer module is a module provided by the Dorothy SSR game engine that contains functionalities related to 2D platform games. On the other hand, the Data module is a singleton object that provides a unified location for storing and accessing globally defined game data.
