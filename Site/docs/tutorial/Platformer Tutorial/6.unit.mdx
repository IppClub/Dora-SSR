...
Next, we create a [Dictionary](../../api/Class/Dictionary) object and set attributes for various game characters:
...
Finally, we save this dictionary object to [Platformer.Data.store](../../api/Class/Platformer/Data#store), so that other modules can access this object:
