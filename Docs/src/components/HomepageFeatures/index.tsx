...
const CoreFeatureList: FeatureItem[] = [
	{
		...
		image: <LazyImage src={require('@site/static/img/showcase/web-ide-retina.webp').default} alt="Dora SSR Web IDE editing an FPSDemo TypeScript project"/>,
	...
	},
	{
		...
		image: <LazyImage src={require('@site/static/img/showcase/dora-agent-retina.webp').default} alt="Coding Agent completing a project analysis task inside Dora SSR"/>,
