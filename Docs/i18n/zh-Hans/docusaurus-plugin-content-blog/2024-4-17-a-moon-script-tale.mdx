...
<p align="center">
  <img src={require('@site/static/img/tokyo-moon.jpg').default} alt="tokyo moon" height="300px"/>
</p>
...
<p align="center">
  <img src={require('@site/static/img/moonscript.png').default} alt="logo里暗藏情怀" height="200px"/>
   logo里暗藏情怀
</p>
