...
# UI 开发绕了一大圈，Dora 为什么又把场景写回程序语言？

![UI 开发绕了一大圈，Dora 为什么又把场景写回程序语言？文章封面](./assets/cover.webp)
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="DoraX 主题贴纸" width="240" /></p>
