...
## 2. 使用 dora-cli 管理外部 TypeScript 项目

&emsp;&emsp;如果你是在 Dora SSR 的 Web IDE 之外开发 TypeScript 项目，也可以使用 [dora-cli](https://github.com/IppClub/Dora-SSR/tree/main/Tools/dora-cli) 来初始化项目、构建代码，并连接到一个正在运行的 Dora SSR 实例执行它。
