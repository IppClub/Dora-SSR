...
&emsp;&emsp;本教程是原始 Teal 教程的稍作修改版，已根据 Dora SSR 进行调整。原教程可在[此处](https://github.com/teal-language/tl/blob/master/docs/tutorial.md)查看。该教程假设你已经了解 Lua，因此我们将重点介绍 Teal 为 Lua 添加的内容，主要是类型声明。
:::
