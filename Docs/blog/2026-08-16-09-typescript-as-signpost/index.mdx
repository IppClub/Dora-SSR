...
Dora supports many programming languages, yet gives TypeScript a more visible role. The choice is less about taste than using type constraints as reliable signposts for both people and Agents.
