...
Codex played the user while Dora Agent made games, then kept testing the results and requesting changes. Dozens of loops became a practical way for one Agent to evaluate another and improve the software itself.
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="Agent game validation sticker" width="320" /></p>
