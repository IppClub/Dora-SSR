...
# A UI Cleanup for Dora Web IDE

![Cover illustration for the Dora Web IDE UI cleanup](./assets/cover.webp)
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="Web IDE UI cleanup sticker" width="240" /></p>
