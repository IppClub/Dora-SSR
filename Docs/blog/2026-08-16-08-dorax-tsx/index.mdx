...
UI development evolved from general-purpose code through XML DSLs, MVC and MVVM, then JSX and data-driven rendering. DoraX brings that history into game scenes and gives TSX a new role.
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="DoraX sticker" width="320" /></p>
