...
<p align="center">
  <img src={require('@site/static/img/art/casual/3.png').default} alt='Multilingual Playground!' height='400px'/>
...
<p align="center">
  <img src={require('@site/static/img/art/casual/2.png').default} alt='Game creation at your fingertips!' height='400px'/>
...
<p align="center">
  <img src={require('@site/static/img/art/casual/1.png').default} alt='Open source everything?' height='400px'/>
...
<p align="center">
  <img src={require('@site/static/img/article/auspice-gear.png').default} alt='Auspice Gear + Dora SSR'/>
...
<p align="center">
  <img src={require('@site/static/img/article/lsd-banner.jpg').default} alt='An open-source indie game project'/>
