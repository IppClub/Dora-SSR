...
<p align="center">
  <img src={require('@site/static/img/art/casual/3.png').default} alt='Multilingual Playground!' width='600px'/>
...
<p align="center">
  <img src={require('@site/static/img/art/casual/2.png').default} alt='Game creation at your fingertips!' width='600px'/>
...
<p align="center">
  <img src={require('@site/static/img/art/casual/1.png').default} alt='Open source everything?' width='600px'/>
