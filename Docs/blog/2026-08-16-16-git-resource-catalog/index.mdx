...
Public source code is not automatically a project another creator can continue. Dora’s Git catalog connects runnable, editable repositories with history—and a three-hour micro Game Jam put that relay into practice.
...
The catalog still contains six public entries tagged `3h-gamejam`: *Void Reflector*, SmallPlane, *Interstellar Dream Architect*, *Red-hot Color-changing Mini-game*, *Bullet Shoot Shoot Shoot Shoot*, and `3hgj-by-RtCt`. These were selected public works whose authors agreed to their inclusion.
...
## Let open source mean more than “you can look”
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="Open-source game relay sticker" width="320" /></p>
