...
An Agent’s long-term memory lives beyond model context—in sessions, summaries, plans, progress records, checkpoints, and Skills. Together, the project becomes a recoverable and reviewable external brain.
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="Agent external brain sticker" width="320" /></p>
