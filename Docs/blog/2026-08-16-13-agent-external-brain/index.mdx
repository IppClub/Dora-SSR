...
# When the Project Becomes the Agent's External Brain

![Cover illustration for Agent memory and storage](./assets/cover.webp)
...
## Five different kinds of memory
...
## Compress context into a handoff
...
## Compress checkpoint bodies without changing a byte
...
<p align="center"><img src={require('./assets/sticker.webp').default} alt="Agent external brain sticker" width="240" /></p>
