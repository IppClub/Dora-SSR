...
<p align="center">
  <img src={require('@site/static/img/showcase/1.webp').default} alt='Dora SSR Code Editor'/>
...
<p align="center">
  <img src={require('@site/static/img/showcase/2.webp').default} alt='Dora SSR Story Editor'/>
...
<p align="center">
  <img src={require('@site/static/img/showcase/3.webp').default} alt='Dora SSR Visual Script Editor'/>
...
<p align="center">
  <img src={require('@site/static/img/showcase/4.webp').default} alt='Dora SSR Animation Preview'/>
...
<p align="center">
  <img src={require('@site/static/img/showcase/dev-everywhere.webp').default} alt='Dora SSR Cross-Platform Development'/>
