...
Publishing source code is only the beginning of distribution. Builds, signatures, mirrors, platform rules, and device entry points still stand between a public-interest open-source project and its users.
