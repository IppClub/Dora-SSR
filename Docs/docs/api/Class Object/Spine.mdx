...
| Parameter | Type | Description |
| --- | --- | --- |
| spineStr | string | The Spine file string for the new instance.<br/>A Spine file string can be a file path with the target file extention like "Spine/item" or file paths with all the related files like "Spine/item.skel|Spine/item.atlas" or "Spine/item.json|Spine/item.atlas". |
