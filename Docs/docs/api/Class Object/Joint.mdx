...
| angularOffset | number | Angle of body-B minus angle of body-A in degrees. |
...
| axisAngle | number | The axis angle of the joint in degrees. |
...
| lowerAngle | number | [optinal] The lower angle limit in degrees (default 0.0). |
| upperAngle | number | [optinal] The upper angle limit in degrees (default 0.0). |
...
| motorSpeed | number | [optinal] The target speed of the joint motor in degrees per second (default 0.0). |
...
| bodyB | Body | The second body to be connected by the joint. |
| worldPos | Vec2 | The position in the world to connect the bodies together. |
| axisAngle | number | The angle of the joint axis in degrees. |
| maxMotorTorque | number | [optional] The maximum torque the joint motor can exert, defaults to 0.0. |
| motorSpeed | number | [optional] The target speed of the joint motor in degrees per second, defaults to 0.0. |
