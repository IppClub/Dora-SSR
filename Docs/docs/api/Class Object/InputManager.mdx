...
&emsp;&emsp;The keyboard or gamepad binding type for generic trigger helpers.
...
&emsp;&emsp;The input action type, containing the action name and trigger.
...
&emsp;&emsp;The action event type emitted by an input manager.
...
&emsp;&emsp;The input event handler type.
