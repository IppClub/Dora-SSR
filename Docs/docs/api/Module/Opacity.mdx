...
&emsp;&emsp;Creates a definition for an action that animates the opacity of a Node from one value to another.
...
| from | number | The starting opacity value of the Node (0-1.0). |
| to | number | The ending opacity value of the Node (0-1.0). |
