...
| Parameter | Type | Description |
| --- | --- | --- |
| key | string | The name of the property to retrieve the previous value of.The old values are values before last change of the component values of the Entity. |
