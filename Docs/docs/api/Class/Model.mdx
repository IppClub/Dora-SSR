...
&emsp;&emsp;Calls the specified function for each node in the model, and stops if the function returns false. The nodes can not be added or removed during the iteration.
