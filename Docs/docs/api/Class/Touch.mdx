...
&emsp;&emsp;The location of the touch event in the current view's logical coordinate system.
...
&emsp;&emsp;The location of the touch event in the world coordinate system.
