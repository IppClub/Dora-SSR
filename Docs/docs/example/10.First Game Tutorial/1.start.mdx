...
1. Download and install the Dora SSR software on your gaming terminal. For detailed installation steps, please refer to the [installation guide here](/docs/tutorial/quick-start#1-安装).
