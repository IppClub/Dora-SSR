...
This tutorial is a slightly modified version of the original Teal tutorial, adapted for Dora SSR. The original tutorial can be found [here](https://github.com/teal-language/tl/blob/master/docs/tutorial.md).
:::
