...
| P0-03 | 固定 Emscripten/Rust/Go/Node/CMake 工具链 | P0-01 | 已完成 | Codex | 本地和 CI 版本一致，版本漂移可见 | `Projects/Web/toolchain.env` 与 `check_web_build_env.sh`；当前固定 Emscripten 5.0.5/Rust 1.85.1/Go 1.24.3/Node 22.14.0/CMake 3.30.5，5.0.5 pthread 全量构建及 Love Player 产物门禁已通过 |
