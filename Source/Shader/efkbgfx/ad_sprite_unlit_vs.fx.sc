$input a_position a_color0 a_texcoord0 a_texcoord1 a_texcoord2 a_texcoord3 a_texcoord4 a_texcoord5
...
void main()
{
    ...
    Input.BlendUV = a_texcoord2;
    Input.Blend_Alpha_Dist_UV = a_texcoord3;
    Input.FlipbookIndex = a_texcoord4;
    Input.AlphaThreshold = a_texcoord5;
