...
void Texture::draw(Graphics *gfx, Quad *q, const Matrix4 &localTransform)
{
	...
	(void) q;
	(void) localTransform;
	throw love::Exception("Embedded Texture drawing requires a Dora graphics adapter.");
}
...
void Texture::drawLayer(Graphics *gfx, int layer, Quad *q, const Matrix4 &m)
{
	...
	(void) q;
	(void) m;
	throw love::Exception("Embedded Texture layer drawing requires a Dora graphics adapter.");
}
