...
// This is the Love 11.5 standard transform parser shared by the Graphics and
// SpriteBatch wrappers. It lives in a dependency-light header in the embedded
// build so Dora can reuse the original Lua overload semantics before the full
// native Graphics renderer is replaced by the state-local Dora adapter.
template <typename T>
