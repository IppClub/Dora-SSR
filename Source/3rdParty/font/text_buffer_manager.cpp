...
TextBufferManager::TextBufferManager(FontManager* _fontManager, bgfx::ProgramHandle basicProgram, bgfx::ProgramHandle distanceProgram, bgfx::ProgramHandle distanceSubpixelProgram)
	: m_fontManager(_fontManager)
	, m_basicProgram(basicProgram)
	, m_distanceProgram(distanceProgram)
	, m_distanceSubpixelProgram(distanceSubpixelProgram)
{
