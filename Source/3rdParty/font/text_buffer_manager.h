...
{
public:
	TextBufferManager(FontManager* _fontManager, bgfx::ProgramHandle basicProgram, bgfx::ProgramHandle distanceProgram, bgfx::ProgramHandle distanceSubpixelProgram);
	~TextBufferManager();
