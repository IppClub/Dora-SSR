...
#	define BGFX_GL_CONFIG_BLIT_EMULATION (BGFX_CONFIG_RENDERER_OPENGLES != 0)
#endif // BGFX_GL_CONFIG_BLIT_EMULATION

#ifndef BGFX_GL_CONFIG_TEXTURE_READ_BACK_EMULATION
#	define BGFX_GL_CONFIG_TEXTURE_READ_BACK_EMULATION (BX_PLATFORM_ANDROID || BX_PLATFORM_LINUX)
