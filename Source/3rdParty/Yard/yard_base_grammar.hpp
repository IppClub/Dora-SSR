...
template <typename Rule_T>
struct StoreFinao : Finao<Store<Rule_T>> { };
...
template <
	typename T0, typename T1, typename T2 = False_T, typename T3 = False_T, typename T4 = False_T, typename T5 = False_T, typename T6 = False_T, typename T7 = False_T, typename T8 = False_T, typename T9 = False_T>
struct Or {
	template <typename ParserState_T>
	static bool Match(ParserState_T& p) {
...
template <
	typename T0, typename T1, typename T2 = True_T, typename T3 = True_T, typename T4 = True_T, typename T5 = True_T, typename T6 = True_T, typename T7 = True_T, typename T8 = True_T, typename T9 = True_T>
struct Seq {
	template <typename ParserState_T>
	static bool Match(ParserState_T& p) {
		typename ParserState_T::Iterator pos = p.GetPos();
...
template <typename T, typename U>
struct StarExcept : Star<Seq<NotAt<U>, T>> { };
} // namespace yard
