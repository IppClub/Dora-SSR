...
struct ktm::detail::array_calc_implement::madd
{
    ...
    {
        loop_op<N, A>::call(out, [](const T& x, const T& y, const T& z) -> T { return ktm_operator_madd(x, y, z); }, x, y, z);
    }
};
...
struct ktm::detail::array_calc_implement::madd_scalar
{
    ...
    {
        loop_op<N, A>::call(out, [&scalar](const T& x, const T& y) -> T { return ktm_operator_madd(x, y, scalar); }, x, y);
    }
};
