...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> project(const V& x,
                                                                                         const V& y) noexcept
{
...
template <class V>
KTM_CORE_FUNC std::enable_if_t<is_vector_v<V> && is_floating_point_base_v<V>, V> reflect(const V& x,
                                                                                         const V& n) noexcept
{
...
refract(const V& x, const V& n, vec_traits_base_t<V> eta) noexcept
{
...
template <class V>
KTM_CORE_FUNC
    std::enable_if_t<is_vector_v<V> && is_listing_type_base_v<type_list<float, double>, V>, vec_traits_base_t<V>>
    length(const V& x) noexcept
{
