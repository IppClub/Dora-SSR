...
sceneGroup = world\group {"scene"}
positionGroup = world\group {"position"}

world\observe "Add", {"scene"}, (entity)->
...
world\observe "AddOrChange", {"position","direction","sprite"}, (entity)->
...
world\observe "Add", {"scene"}, (entity)-> entity.scene\schedule ->
