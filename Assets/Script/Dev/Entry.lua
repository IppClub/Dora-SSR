...
footerWindow = threadLoop(function() -- 946
	...
	if isInEntry then -- 1057
		local showURL = true -- 1058
		local webIDEWidth -- 1059
		do -- 1059
			local base -- 1060
			if config.updateNotification then -- 1060
				base = 460 -- 1060
			else -- 1060
				base = 360 -- 1060
			end -- 1060
			local extra -- 1061
			if config.authRequired then -- 1061
				extra = 35 -- 1061
			else -- 1061
				extra = 0 -- 1061
			end -- 1061
			webIDEWidth = base + extra -- 1062
		end -- 1059
		if width < webIDEWidth then -- 1063
			showURL = false -- 1063
		end -- 1063
		SetNextWindowBgAlpha(0.0) -- 1064
		SetNextWindowPos(Vec2(width, height - 50), "Always", Vec2(1, 0)) -- 1065
		Begin("Web IDE", displayWindowFlags, function() -- 1066
			local pending = AuthSession.getPending() -- 1067
			local hovered = false -- 1068
			if not pending and showURL then -- 1069
				do -- 1070
					local url -- 1070
					if webStatus ~= nil then -- 1070
						url = webStatus.url -- 1070
					end -- 1070
					if url then -- 1070
						if isDesktop and not config.fullScreen then -- 1071
							if urlClicked then -- 1072
								BeginDisabled(function() -- 1073
									return Button(url) -- 1073
								end) -- 1073
							elseif Button(url) then -- 1074
								urlClicked = once(function() -- 1075
									return sleep(5) -- 1075
								end) -- 1075
								App:openURL("http://localhost:8866") -- 1076
							end -- 1072
						else -- 1078
							TextColored(descColor, url) -- 1078
						end -- 1071
					else -- 1080
						TextColored(descColor, zh and '不可用' or 'not available') -- 1080
					end -- 1070
				end -- 1070
				hovered = IsItemHovered() -- 1081
			else -- 1083
				TextColored(descColor, "(?)") -- 1083
				hovered = IsItemHovered() -- 1084
			end -- 1069
			SameLine() -- 1085
			local themeColor = App.themeColor -- 1086
			if pending then -- 1087
				if not pending.approved then -- 1088
					local remaining = math.max(0, pending.expiresAt - os.time()) -- 1089
					local ttl = pending.ttl or 1 -- 1090
					PushStyleColor("Text", themeColor, function() -- 1091
						ImGui.ProgressBar(remaining / ttl, Vec2(40, 30), pending.confirmCode) -- 1092
						hovered = hovered or IsItemHovered() -- 1093
					end) -- 1091
					SameLine() -- 1094
					if Button(zh and "确认" or "Approve", Vec2(70, 30)) then -- 1095
						AuthSession.approvePending(pending.sessionId) -- 1096
					end -- 1095
					if hovered then -- 1097
						return BeginTooltip(function() -- 1098
							return PushTextWrapPos(280, function() -- 1099
								return Text(zh and 'Web IDE 正在等待确认，请核对浏览器中的会话码并点击确认' or 'Web IDE is waiting for confirmation. Match the session code in the browser and click approve.') -- 1100
							end) -- 1099
						end) -- 1098
					end -- 1097
				end -- 1088
				...
				if config.authRequired then -- 1102
					PushStyleColor("Text", themeColor, function() -- 1103
						ImGui.ProgressBar(authCodeTTL / 30.0, Vec2(60, 30), authCode) -- 1104
						hovered = hovered or IsItemHovered() -- 1105
					end) -- 1103
					if hovered then -- 1106
						return BeginTooltip(function() -- 1107
							return PushTextWrapPos(280, function() -- 1108
								local url -- 1109
								if webStatus ~= nil then -- 1109
									url = webStatus.url -- 1109
								end -- 1109
								if url then -- 1109
									local address -- 1110
									if showURL then -- 1110
										address = "Web IDE" -- 1110
									else -- 1110
										address = url -- 1110
									end -- 1110
									return Text(zh and "在本机或是本地局域网连接的其他设备上，使用浏览器访问 " .. tostring(address) .. " 并输入后面的 PIN 码进行使用 （PIN 仅用于一次认证）" or "Open " .. tostring(address) .. " in a browser on this machine or another device on the local network and enter the PIN below to start (PIN is one-time)") -- 1111
								else -- 1113
									return Text(zh and 'Web IDE 不可用' or 'Web IDE not available') -- 1113
								end -- 1109
							end) -- 1108
						end) -- 1107
					end -- 1106
				else -- 1115
					if hovered then -- 1115
						return BeginTooltip(function() -- 1116
							return PushTextWrapPos(280, function() -- 1117
								local url -- 1118
								if webStatus ~= nil then -- 1118
									url = webStatus.url -- 1118
								end -- 1118
								if url then -- 1118
									local address -- 1119
									if showURL then -- 1119
										address = "Web IDE" -- 1119
									else -- 1119
										address = url -- 1119
									end -- 1119
									return Text(zh and "在本机或是本地局域网连接的其他设备上，使用浏览器访问 " .. tostring(address) or "Open " .. tostring(address) .. " in a browser on this machine or another device on the local network") -- 1120
								else -- 1122
									return Text(zh and 'Web IDE 不可用' or 'Web IDE not available') -- 1122
								end -- 1118
							end) -- 1117
						end) -- 1116
					end -- 1115
	...
	if not isInEntry then -- 1124
		SetNextWindowSize(Vec2(50, 50)) -- 1125
		SetNextWindowPos(Vec2(width - 50, height - 50)) -- 1126
		PushStyleColor("WindowBg", transparant, function() -- 1127
			return Begin("Show", displayWindowFlags, function() -- 1127
				if width >= 370 then -- 1128
					local changed -- 1129
					changed, showFooter = Checkbox("##dev", showFooter) -- 1129
					if changed then -- 1129
						config.showFooter = showFooter -- 1130
					end -- 1129
				end -- 1128
			end) -- 1127
		end) -- 1127
	end -- 1124
	if isInEntry or showFooter then -- 1132
		if showStats then -- 1133
		...
		if showConsole then -- 1139
			SetNextWindowPos(Vec2(width - 425, height - 375), "FirstUseEver") -- 1140
			return PushStyleVar("WindowRounding", 6, function() -- 1141
				return ShowConsole() -- 1142
			end) -- 1141
		end -- 1139
	end -- 1132
end) -- 946
local MaxWidth <const> = 960 -- 1144
local toolOpen = false -- 1146
local filterText = nil -- 1147
local anyEntryMatched = false -- 1148
local match -- 1149
match = function(name) -- 1149
	local res = not filterText or name:lower():match(filterText) -- 1150
	if res then -- 1151
		anyEntryMatched = true -- 1151
	end -- 1151
	return res -- 1152
end -- 1149
local sep -- 1154
sep = function() -- 1154
	return SeparatorText("") -- 1154
end -- 1154
local thinSep -- 1155
thinSep = function() -- 1155
	return PushStyleVar("SeparatorTextBorderSize", 1, sep) -- 1155
end -- 1155
entryWindow = threadLoop(function() -- 1157
	if App.fpsLimited ~= config.fpsLimited then -- 1158
		config.fpsLimited = App.fpsLimited -- 1159
	end -- 1158
	if App.targetFPS ~= config.targetFPS then -- 1160
		config.targetFPS = App.targetFPS -- 1161
	end -- 1160
	if View.vsync ~= config.vsync then -- 1162
		config.vsync = View.vsync -- 1163
	end -- 1162
	if Director.scheduler.fixedFPS ~= config.fixedFPS then -- 1164
		config.fixedFPS = Director.scheduler.fixedFPS -- 1165
	end -- 1164
	if Director.profilerSending ~= config.webProfiler then -- 1166
		config.webProfiler = Director.profilerSending -- 1167
	end -- 1166
	if urlClicked then -- 1168
		local _, result = coroutine.resume(urlClicked) -- 1169
		if result then -- 1170
			coroutine.close(urlClicked) -- 1171
			urlClicked = nil -- 1172
		end -- 1170
	end -- 1168
	if not showEntry then -- 1173
		return -- 1173
	end -- 1173
	if not isInEntry then -- 1174
		return -- 1174
	end -- 1174
	...
	if HttpServer.wsConnectionCount > 0 then -- 1177
		...
		do -- 1178
			...
			width, height = _obj_0.width, _obj_0.height -- 1178
		end -- 1178
		SetNextWindowBgAlpha(0.5) -- 1179
		SetNextWindowPos(Vec2(width / 2, height / 2), "Always", Vec2(0.5, 0.5)) -- 1180
		Begin("Web IDE Connected", displayWindowFlags, function() -- 1181
			Separator() -- 1182
			TextColored(themeColor, tostring(zh and 'Web IDE 已连接 ……' or 'Web IDE connected ...')) -- 1183
			if iconTex then -- 1184
				Image(icon, Vec2(24, 24)) -- 1185
				SameLine() -- 1186
			end -- 1184
			local slogon = zh and 'Dora 启动！' or 'Dora Start!' -- 1187
			TextColored(descColor, slogon) -- 1188
			return Separator() -- 1189
		end) -- 1181
		return -- 1190
	end -- 1177
	local fullWidth, height -- 1192
	do -- 1192
		local _obj_0 = App.visualSize -- 1192
		fullWidth, height = _obj_0.width, _obj_0.height -- 1192
	end -- 1192
	local width = math.min(MaxWidth, fullWidth) -- 1193
	local paddingX = math.max(10, fullWidth / 2 - width / 2 - 10) -- 1194
	local maxColumns = math.max(math.floor(width / 200), 1) -- 1195
	SetNextWindowPos(Vec2.zero) -- 1196
	SetNextWindowBgAlpha(0) -- 1197
	SetNextWindowSize(Vec2(fullWidth, 60)) -- 1198
	do -- 1199
		PushStyleVar("WindowPadding", Vec2(10, 0), function() -- 1200
			return Begin("Dora Dev", windowFlags, function() -- 1201
				...
				if fullWidth >= 400 then -- 1204
					...
					if Button(zh and '下载' or 'Download') then -- 1212
						allClear() -- 1213
						enterDemoEntry({ -- 1215
							entryName = "ResourceDownloader", -- 1215
							fileName = Path(Content.assetPath, "Script", "Tools", "ResourceDownloader") -- 1216
						}) -- 1214
					end -- 1212
				end -- 1204
				Separator() -- 1217
				return Dummy(Vec2(fullWidth - 20, 0)) -- 1218
			end) -- 1201
		end) -- 1200
	end -- 1199
	anyEntryMatched = false -- 1220
	SetNextWindowPos(Vec2(0, 50)) -- 1221
	SetNextWindowSize(Vec2(fullWidth, height - 100)) -- 1222
	do -- 1223
		return PushStyleColor("WindowBg", transparant, function() -- 1224
			return PushStyleVar("WindowPadding", Vec2(paddingX, 10), function() -- 1225
				return PushStyleVar("Alpha", 1, function() -- 1226
					return Begin("Content", windowFlags, function() -- 1227
						local DemoViewWidth <const> = 220 -- 1228
						filterText = filterBuf.text:match("[^%%%.%[]+") -- 1229
						if filterText then -- 1230
							filterText = filterText:lower() -- 1230
						end -- 1230
						if #gamesInDev > 0 then -- 1231
							local columns = math.max(math.floor(width / DemoViewWidth), 1) -- 1232
							Columns(columns, false) -- 1233
							local realViewWidth = GetColumnWidth() - 50 -- 1234
							for _index_0 = 1, #gamesInDev do -- 1235
								local game = gamesInDev[_index_0] -- 1235
								local gameName, fileName, examples, tests, repo, bannerFile, bannerTex = game.entryName, game.fileName, game.examples, game.tests, game.repo, game.bannerFile, game.bannerTex -- 1236
								local displayName -- 1245
								if repo then -- 1245
									if zh then -- 1246
										displayName = repo.title.zh -- 1246
									else -- 1246
										displayName = repo.title.en -- 1246
									end -- 1246
								end -- 1245
								if displayName == nil then -- 1247
									displayName = gameName -- 1247
								end -- 1247
								if match(displayName) then -- 1248
									TextColored(themeColor, zh and "项目：" or "Project:") -- 1249
									SameLine() -- 1250
									TextWrapped(displayName) -- 1251
									if columns > 1 then -- 1252
										if bannerFile then -- 1253
											local texWidth, texHeight = bannerTex.width, bannerTex.height -- 1254
											local displayWidth <const> = realViewWidth -- 1255
											texHeight = displayWidth * texHeight / texWidth -- 1256
											texWidth = displayWidth -- 1257
											Dummy(Vec2.zero) -- 1258
											SameLine() -- 1259
											Image(bannerFile, Vec2(texWidth + 10, texHeight)) -- 1260
										end -- 1253
										if Button(tostring(zh and "开始测试" or "Game Test") .. "##" .. tostring(fileName), Vec2(-1, 40)) then -- 1261
											enterDemoEntry(game) -- 1262
										end -- 1261
									else -- 1264
										if bannerFile then -- 1264
											local texWidth, texHeight = bannerTex.width, bannerTex.height -- 1265
											local displayWidth = (fullWidth / 2 - paddingX) * 2 - 35 -- 1266
											local sizing = 0.8 -- 1267
											texHeight = displayWidth * sizing * texHeight / texWidth -- 1268
											texWidth = displayWidth * sizing -- 1269
											if texWidth > 500 then -- 1270
												sizing = 0.6 -- 1271
												texHeight = displayWidth * sizing * texHeight / texWidth -- 1272
												texWidth = displayWidth * sizing -- 1273
											end -- 1270
											local padding = displayWidth * (1 - sizing) / 2 - 10 -- 1274
											Dummy(Vec2(padding, 0)) -- 1275
											SameLine() -- 1276
											Image(bannerFile, Vec2(texWidth, texHeight)) -- 1277
										end -- 1264
										if Button(tostring(zh and "开始测试" or "Game Test") .. "##" .. tostring(fileName), Vec2(-1, 40)) then -- 1278
											enterDemoEntry(game) -- 1279
										end -- 1278
									end -- 1252
									if #tests == 0 and #examples == 0 then -- 1280
										thinSep() -- 1281
									end -- 1280
									NextColumn() -- 1282
								end -- 1248
								local showSep = false -- 1283
								if #examples > 0 then -- 1284
									local showExample = false -- 1285
									for _index_1 = 1, #examples do -- 1286
										local _des_0 = examples[_index_1] -- 1286
										local entryName = _des_0.entryName -- 1286
										if match(entryName) then -- 1287
											showExample = true -- 1287
											break -- 1287
										end -- 1287
									end -- 1286
									if showExample then -- 1288
										showSep = true -- 1289
										Columns(1, false) -- 1290
										TextColored(themeColor, zh and "示例：" or "Example:") -- 1291
										SameLine() -- 1292
										local opened -- 1293
										if (filterText ~= nil) then -- 1293
											opened = showExample -- 1293
										else -- 1293
											opened = false -- 1293
										end -- 1293
										if game.exampleOpen == nil then -- 1294
											game.exampleOpen = opened -- 1294
										end -- 1294
										SetNextItemOpen(game.exampleOpen) -- 1295
										TreeNode(tostring(gameName) .. "##example-" .. tostring(fileName), function() -- 1296
											return PushStyleVar("ItemSpacing", Vec2(20, 10), function() -- 1297
												Columns(maxColumns, false) -- 1298
												for _index_1 = 1, #examples do -- 1299
													local example = examples[_index_1] -- 1299
													local entryName = example.entryName -- 1300
													if not match(entryName) then -- 1301
														goto _continue_0 -- 1301
													end -- 1301
													PushID(tostring(gameName) .. " " .. tostring(entryName) .. " example", function() -- 1302
														if Button(entryName, Vec2(-1, 40)) then -- 1303
															enterDemoEntry(example) -- 1304
														end -- 1303
														return NextColumn() -- 1305
													end) -- 1302
													opened = true -- 1306
													::_continue_0:: -- 1300
												end -- 1299
										...
										game.exampleOpen = opened -- 1307
									end -- 1288
								end -- 1284
								if #tests > 0 then -- 1308
									local showTest = false -- 1309
									for _index_1 = 1, #tests do -- 1310
										local _des_0 = tests[_index_1] -- 1310
										local entryName = _des_0.entryName -- 1310
										if match(entryName) then -- 1311
											showTest = true -- 1311
											break -- 1311
										end -- 1311
									end -- 1310
									if showTest then -- 1312
										showSep = true -- 1313
										Columns(1, false) -- 1314
										TextColored(themeColor, zh and "测试：" or "Test:") -- 1315
										SameLine() -- 1316
										local opened -- 1317
										if (filterText ~= nil) then -- 1317
											opened = showTest -- 1317
										else -- 1317
											opened = false -- 1317
										end -- 1317
										if game.testOpen == nil then -- 1318
											game.testOpen = opened -- 1318
										end -- 1318
										SetNextItemOpen(game.testOpen) -- 1319
										TreeNode(tostring(gameName) .. "##test-" .. tostring(fileName), function() -- 1320
											return PushStyleVar("ItemSpacing", Vec2(20, 10), function() -- 1321
												Columns(maxColumns, false) -- 1322
												for _index_1 = 1, #tests do -- 1323
													local test = tests[_index_1] -- 1323
													local entryName = test.entryName -- 1324
													if not match(entryName) then -- 1325
														goto _continue_0 -- 1325
													end -- 1325
													PushID(tostring(gameName) .. " " .. tostring(entryName) .. " test", function() -- 1326
														if Button(entryName, Vec2(-1, 40)) then -- 1327
															enterDemoEntry(test) -- 1328
														end -- 1327
														return NextColumn() -- 1329
													end) -- 1326
													opened = true -- 1330
													::_continue_0:: -- 1324
												end -- 1323
										...
										game.testOpen = opened -- 1331
									end -- 1312
								end -- 1308
								if showSep then -- 1332
									Columns(1, false) -- 1333
									thinSep() -- 1334
									Columns(columns, false) -- 1335
								end -- 1332
							end -- 1235
						end -- 1231
						if #doraTools > 0 then -- 1336
							local showTool = false -- 1337
							for _index_0 = 1, #doraTools do -- 1338
								local _des_0 = doraTools[_index_0] -- 1338
								local entryName = _des_0.entryName -- 1338
								if match(entryName) then -- 1339
									showTool = true -- 1339
									break -- 1339
								end -- 1339
							end -- 1338
							if not showTool then -- 1340
								goto endEntry -- 1340
							end -- 1340
							Columns(1, false) -- 1341
							TextColored(themeColor, "Dora SSR:") -- 1342
							SameLine() -- 1343
							Text(zh and "开发支持" or "Development Support") -- 1344
							Separator() -- 1345
							if #doraTools > 0 then -- 1346
								local opened -- 1347
								if (filterText ~= nil) then -- 1347
									opened = showTool -- 1347
								else -- 1347
									opened = false -- 1347
								end -- 1347
								SetNextItemOpen(toolOpen) -- 1348
								TreeNode(zh and "引擎工具" or "Engine Tools", function() -- 1349
									return PushStyleVar("ItemSpacing", Vec2(20, 10), function() -- 1350
										Columns(maxColumns, false) -- 1351
										for _index_0 = 1, #doraTools do -- 1352
											local example = doraTools[_index_0] -- 1352
											local entryName = example.entryName -- 1353
											if not match(entryName) then -- 1354
												goto _continue_0 -- 1354
											end -- 1354
											if Button(entryName, Vec2(-1, 40)) then -- 1355
												enterDemoEntry(example) -- 1356
											end -- 1355
											NextColumn() -- 1357
											::_continue_0:: -- 1353
										end -- 1352
								...
								toolOpen = opened -- 1360
							end -- 1346
						end -- 1336
						::endEntry:: -- 1361
						if not anyEntryMatched then -- 1362
							SetNextWindowBgAlpha(0) -- 1363
							SetNextWindowPos(Vec2(fullWidth / 2, height / 2), "Always", Vec2(0.5, 0.5)) -- 1364
							Begin("Entries Not Found", displayWindowFlags, function() -- 1365
								Separator() -- 1366
								TextColored(themeColor, zh and "多萝：" or "Dora:") -- 1367
								TextColored(descColor, zh and '别担心，改变一些咒语，我们会找到新的冒险～' or 'Don\'t worry, more magic words and we\'ll find a new adventure!') -- 1368
								return Separator() -- 1369
							end) -- 1365
						end -- 1362
						Columns(1, false) -- 1370
						Dummy(Vec2(100, 80)) -- 1371
						return ScrollWhenDraggingOnVoid() -- 1372
					end) -- 1227
				end) -- 1226
			end) -- 1225
		end) -- 1224
...
webStatus = require("Script.Dev.WebServer") -- 1374
return _module_0 -- 1
