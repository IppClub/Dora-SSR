		...
		return PushStyleColor("WindowBg", transparant, function() -- 996
			return PushStyleVar("WindowPadding", Vec2(paddingX, 10), function() -- 997
				return Begin("Content", windowFlags, function() -- 998
					local demoViewWith <const> = 400 -- 999
					filterText = filterBuf.text:match("[^%%%.%[]+") -- 1000
					if filterText then -- 1001
						filterText = filterText:lower() -- 1001
					end -- 1001
					if #gamesInDev > 0 then -- 1002
						local columns = math.max(math.floor(width / demoViewWith), 1) -- 1003
						Columns(columns, false) -- 1004
						for _index_0 = 1, #gamesInDev do -- 1005
							local game = gamesInDev[_index_0] -- 1005
							local gameName, fileName, examples, tests, bannerFile, bannerTex = game[1], game[2], game[3], game[4], game[5], game[6] -- 1006
							if match(gameName) then -- 1007
								TextColored(themeColor, zh and "项目：" or "Project:") -- 1008
								SameLine() -- 1009
								TextWrapped(gameName) -- 1010
								if columns > 1 then -- 1011
									if bannerFile then -- 1012
										local texWidth, texHeight = bannerTex.width, bannerTex.height -- 1013
										local displayWidth <const> = demoViewWith - 40 -- 1014
										texHeight = displayWidth * texHeight / texWidth -- 1015
										texWidth = displayWidth -- 1016
										PushID(fileName, function() -- 1017
											if ImageButton(gameName, bannerFile, Vec2(texWidth + 10, texHeight)) then -- 1018
												return enterDemoEntry(game) -- 1019
											end -- 1018
										end) -- 1017
									else -- 1021
										PushID(fileName, function() -- 1021
											if Button(zh and "开始运行" or "Game Start", Vec2(-1, 40)) then -- 1022
												return enterDemoEntry(game) -- 1023
											end -- 1022
										end) -- 1021
									end -- 1012
								else -- 1025
									if bannerFile then -- 1025
										...
										SameLine() -- 1037
										PushID(fileName, function() -- 1038
											if ImageButton(gameName, bannerFile, Vec2(texWidth, texHeight)) then -- 1039
												return enterDemoEntry(game) -- 1040
											end -- 1039
										end) -- 1038
									else -- 1042
										PushID(fileName, function() -- 1042
											if Button(zh and "开始运行" or "Game Start", Vec2(-1, 40)) then -- 1043
												return enterDemoEntry(game) -- 1044
											end -- 1043
										end) -- 1042
									end -- 1025
								end -- 1011
								if #tests == 0 and #examples == 0 then -- 1045
									thinSep() -- 1046
								end -- 1045
								NextColumn() -- 1047
							end -- 1007
							local showSep = false -- 1048
							if #examples > 0 then -- 1049
								local showExample = false -- 1050
								do -- 1051
									local _accum_0 -- 1051
									for _index_1 = 1, #examples do -- 1051
										local _des_0 = examples[_index_1] -- 1051
									...
									showExample = _accum_0 -- 1051
								end -- 1052
								if showExample then -- 1053
									showSep = true -- 1054
									Columns(1, false) -- 1055
									TextColored(themeColor, zh and "示例：" or "Example:") -- 1056
									SameLine() -- 1057
									local opened -- 1058
									if (filterText ~= nil) then -- 1058
										opened = showExample -- 1058
									else -- 1058
										opened = false -- 1058
									end -- 1058
									if game.exampleOpen == nil then -- 1059
										game.exampleOpen = opened -- 1059
									end -- 1059
									SetNextItemOpen(game.exampleOpen) -- 1060
									TreeNode(tostring(gameName) .. "###example-" .. tostring(fileName), function() -- 1061
										return PushStyleVar("ItemSpacing", Vec2(20, 10), function() -- 1062
											Columns(maxColumns, false) -- 1063
											for _index_1 = 1, #examples do -- 1064
												local example = examples[_index_1] -- 1064
												if not match(example[1]) then -- 1065
													goto _continue_0 -- 1065
												end -- 1065
												PushID(tostring(gameName) .. " " .. tostring(example[1]) .. " example", function() -- 1066
													if Button(example[1], Vec2(-1, 40)) then -- 1067
														enterDemoEntry(example) -- 1068
													end -- 1067
													return NextColumn() -- 1069
												end) -- 1066
												opened = true -- 1070
												::_continue_0:: -- 1065
											end -- 1070
							...
							if #tests > 0 then -- 1072
								...
								do -- 1074
									...
									for _index_1 = 1, #tests do -- 1074
										local _des_0 = tests[_index_1] -- 1074
									...
									showTest = _accum_0 -- 1074
								end -- 1075
								if showTest then -- 1076
									showSep = true -- 1077
									Columns(1, false) -- 1078
									TextColored(themeColor, zh and "测试：" or "Test:") -- 1079
									SameLine() -- 1080
									local opened -- 1081
									if (filterText ~= nil) then -- 1081
										opened = showTest -- 1081
									else -- 1081
										opened = false -- 1081
									end -- 1081
									if game.testOpen == nil then -- 1082
										game.testOpen = opened -- 1082
									end -- 1082
									SetNextItemOpen(game.testOpen) -- 1083
									TreeNode(tostring(gameName) .. "###test-" .. tostring(fileName), function() -- 1084
										return PushStyleVar("ItemSpacing", Vec2(20, 10), function() -- 1085
											Columns(maxColumns, false) -- 1086
											for _index_1 = 1, #tests do -- 1087
												local test = tests[_index_1] -- 1087
												if not match(test[1]) then -- 1088
													goto _continue_0 -- 1088
												end -- 1088
												PushID(tostring(gameName) .. " " .. tostring(test[1]) .. " test", function() -- 1089
													if Button(test[1], Vec2(-1, 40)) then -- 1090
														enterDemoEntry(test) -- 1091
													end -- 1090
									...
									game.testOpen = opened -- 1094
								end -- 1076
							end -- 1072
							if showSep then -- 1095
								Columns(1, false) -- 1096
								thinSep() -- 1097
								Columns(columns, false) -- 1098
							end -- 1095
						end -- 1098
					end -- 1002
					if #doraTools > 0 then -- 1099
						...
						do -- 1101
							...
							showTool = _accum_0 -- 1101
						end -- 1102
						if not showTool then -- 1103
							goto endEntry -- 1103
						end -- 1103
						Columns(1, false) -- 1104
						TextColored(themeColor, "Dora SSR:") -- 1105
						SameLine() -- 1106
						Text(zh and "开发支持" or "Development Support") -- 1107
						Separator() -- 1108
						if #doraTools > 0 then -- 1109
							local opened -- 1110
							if (filterText ~= nil) then -- 1110
								opened = showTool -- 1110
							else -- 1110
								opened = false -- 1110
							end -- 1110
							SetNextItemOpen(toolOpen) -- 1111
							TreeNode(zh and "引擎工具" or "Engine Tools", function() -- 1112
								return PushStyleVar("ItemSpacing", Vec2(20, 10), function() -- 1113
									Columns(maxColumns, false) -- 1114
									for _index_0 = 1, #doraTools do -- 1115
										local example = doraTools[_index_0] -- 1115
										if not match(example[1]) then -- 1116
											goto _continue_0 -- 1116
										end -- 1116
										if Button(example[1], Vec2(-1, 40)) then -- 1117
											enterDemoEntry(example) -- 1118
										end -- 1117
										NextColumn() -- 1119
										::_continue_0:: -- 1116
									end -- 1119
							...
							toolOpen = opened -- 1122
						end -- 1109
					end -- 1099
					::endEntry:: -- 1123
					if not anyEntryMatched then -- 1124
						SetNextWindowBgAlpha(0) -- 1125
						SetNextWindowPos(Vec2(fullWidth / 2, height / 2), "Always", Vec2(0.5, 0.5)) -- 1126
						Begin("Entries Not Found", displayWindowFlags, function() -- 1127
							Separator() -- 1128
							TextColored(themeColor, zh and "多萝：" or "Dora:") -- 1129
							TextColored(descColor, zh and '别担心，改变一些咒语，我们会找到新的冒险～' or 'Don\'t worry, more magic words and we\'ll find a new adventure!') -- 1130
							return Separator() -- 1131
						end) -- 1127
					end -- 1124
					Columns(1, false) -- 1132
					Dummy(Vec2(100, 80)) -- 1133
					return ScrollWhenDraggingOnVoid() -- 1134
				end) -- 998
			end) -- 997
		end) -- 996
	end -- 1134
end) -- 899
webStatus = require("Script.Dev.WebServer") -- 1136
return _module_0 -- 1136
