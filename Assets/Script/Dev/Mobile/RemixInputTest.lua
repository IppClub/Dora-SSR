...
D.thread(function()
	...
	D.Content:save("/tmp/dora-remix-input.result",ok and "passed placeholderFocusBlur=1 caretBlink=1 clipHierarchy=1 multilineReturn=1 utf8CaretEdit=1 composition=1 exactSend=1 caretFollow=1 wheel=1 arrows=1 tap=1 keptInput=1 noLLM=1\n" or "failed: "..tostring(err))
end)
