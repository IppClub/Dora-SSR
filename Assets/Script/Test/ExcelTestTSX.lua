...
local ui = toNode(React.createElement( -- 360
	...
	{ -- 360
		...
		onButtonDown = function(id, buttonName) -- 360
			...
			repeat -- 363
				local ____switch47 = buttonName -- 363
				local ____cond47 = ____switch47 == "dpleft" -- 363
				if ____cond47 then -- 363
					updatePlayerControl("keyLeft", true, true) -- 365
					break -- 365
				end -- 365
				____cond47 = ____cond47 or ____switch47 == "dpright" -- 365
				if ____cond47 then -- 365
					updatePlayerControl("keyRight", true, true) -- 366
					break -- 366
				end -- 366
				____cond47 = ____cond47 or ____switch47 == "b" -- 366
		...
		onButtonUp = function(id, buttonName) -- 362
			...
			repeat -- 371
				local ____switch50 = buttonName -- 371
				local ____cond50 = ____switch50 == "dpleft" -- 371
				if ____cond50 then -- 371
					updatePlayerControl("keyLeft", false, true) -- 373
					break -- 373
				end -- 373
				____cond50 = ____cond50 or ____switch50 == "dpright" -- 373
				if ____cond50 then -- 373
					updatePlayerControl("keyRight", false, true) -- 374
					break -- 374
				end -- 374
				____cond50 = ____cond50 or ____switch50 == "b" -- 374
