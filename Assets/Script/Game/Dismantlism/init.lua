...
local _anon_func_0 = function(Grid, Vec2, _with_1, h, w) -- 55
...
local _anon_func_1 = function(Sprite, _with_2, x, y) -- 63
...
do -- 38
	...
	_with_0:slot("AlignLayout", function(w, h) -- 39
		...
		do -- 46
			...
			_with_1.order = -1 -- 48
			_with_1:addChild(_anon_func_0(Grid, Vec2, _with_1, h, w)) -- 49
			_with_1:addChild((function() -- 56
				...
				for y = 1, 8 do -- 59
					for x = 1, 8 do -- 59
						_with_2:addChild(_anon_func_1(Sprite, _with_2, x, y)) -- 60
					end -- 63
				end -- 63
...
local _anon_func_2 = function(Color, Label, _with_0) -- 234
...
local _anon_func_3 = function(Delay, Ease, Event, Node, Opacity, Scale, Sequence, Spawn, Sprite, _with_1, body) -- 269
...
buildScene = function() -- 204
	for i = 1, scene:count() do -- 205
		...
		if "removearea" == file then -- 228
			...
			_with_0:addChild(_anon_func_2(Color, Label, _with_0)) -- 231
				...
				_with_1:slot("Destroy", function() -- 244
					do -- 245
						...
						elseif "credit" == _exp_0 then -- 254
							score = score + 50 -- 255
							world:addChild(_anon_func_3(Delay, Ease, Event, Node, Opacity, Scale, Sequence, Spawn, Sprite, _with_1, body)) -- 256
						else -- 271
							score = score + 10 -- 271
						end -- 271
					end -- 271
