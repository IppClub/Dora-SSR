...
interface App {
	...
	/**
	 * A uniformly distributed 32-bit unsigned integer generated by the Mersenne Twister engine,
	 * in the inclusive range 0 to 4,294,967,295. This value is not normalized to [0, 1].
	 * Divide it by 4,294,967,295 when a normalized random value is needed.
...
class Label extends Node {
	 ...
	 * Only works with SDF labels. Each component is clamped to 0 to 1 and the lower value is kept below the upper value.
