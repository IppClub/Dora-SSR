...
--[[
 ...
 output('{')
	foreach(_usertype,function(n,v)
		if ((not _global_classes[v]) or _global_classes[v]:check_public_access()) and v ~= "tolua_table" and v ~= "tolua_function" and v ~= "tolua_function_bool" and v ~= "tolua_handler" then
