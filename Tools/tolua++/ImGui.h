...
namespace ImGui
{
	...
	void Binding::ImageTexture @ ImageTexture(Texture2D* texture, Vec2 size, Color bg_col = Color(0x0), Color tint_col = Color(0xffffffff));
	...
	bool Binding::DragFloat @ DragFloat(CString label, float* v, float v_speed, float v_min, float v_max, CString display_format = "%.2f");
	...
	bool Binding::DragFloat2 @ DragFloat2(CString label, float* v1, float* v2, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, CString display_format = "%.2f");
	...
	bool Binding::InputFloat @ InputFloat(CString label, float* v, float step = 0.0f, float step_fast = 0.0f, CString format = "%.2f");
	...
	bool Binding::InputFloat2 @ InputFloat2(CString label, float* v1, float* v2, CString format = "%.2f");
	...
	bool Binding::SliderFloat @ SliderFloat(CString label, float* v, float v_min, float v_max, CString format = "%.2f");
	bool Binding::SliderFloat @ SliderFloat(CString label, float* v, float v_min, float v_max, CString format, String flags[tolua_len]);
	bool Binding::SliderFloat2 @ SliderFloat2(CString label, float* v1, float* v2, float v_min, float v_max, CString display_format = "%.2f");
	...
	bool Binding::SliderInt2 @ SliderInt2(CString label, int* v1, int* v2, int v_min, int v_max, CString display_format = "%d");
	...
	bool Binding::DragFloatRange2 @ DragFloatRange2(CString label, float* v_current_min, float* v_current_max, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, CString format = "%.2f", CString format_max = nullptr);
	...
	bool Binding::VSliderFloat @ VSliderFloat(CString label, Vec2 size, float* v, float v_min, float v_max, CString format = "%.2f");
