...
object class RenderTarget
{
	...
	/// * `computeAccess` - The compute access mode for the render target texture. Default is ReadWrite.
	///
	/// # Returns
	///
...
object class ComputePass : public Object
{
	...
	/// * `y` - The second value to set (default 0.0).
	/// * `z` - The third value to set (default 0.0).
	/// * `w` - The fourth value to set (default 0.0).
	void set(String name, float x, float y, float z, float w);
	/// Sets a Color value for a shader parameter.
	///
	/// # Arguments
	///
	/// * `name` - The name of the parameter to set.
	...
	/// Sets a texture for image load/store operations in compute shader.
	///
	/// # Arguments
	///
	/// * `slot` - The texture slot to bind to, in range [0..3].
	/// * `texture` - The texture to bind.
	/// * `access` - The compute access mode for the texture.
	void setImage(uint8_t slot, Texture2D* texture, ComputeAccess access);
	/// Dispatches the compute shader.
	///
	/// # Arguments
	///
	/// * `x` - The number of work groups in the X dimension.
	/// * `y` - The number of work groups in the Y dimension (default 1).
	/// * `z` - The number of work groups in the Z dimension (default 1).
	...
	/// # Arguments
	///
	/// * `name` - The name of the compiled compute shader file.
	///
	/// # Returns
	///
	/// * `ComputePass` - A new ComputePass object or None if creation failed.
