extern "C" {
	...
	fn dbquery_add_with_params(slf: i64, sql: i64, record: i64);
...
impl DBQuery {
	...
	pub fn add_with_params(&mut self, sql: &str, record: crate::dora::DBRecord) {
		unsafe { dbquery_add_with_params(self.raw(), crate::dora::from_string(sql), record.raw()); }
	}
