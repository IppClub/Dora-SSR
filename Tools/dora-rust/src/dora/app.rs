...
impl App {
	...
	pub fn get_buffer_size() -> crate::dora::Size {
		return crate::dora::Size::from(unsafe { application_get_buffer_size() });
	}
	pub fn get_visual_size() -> crate::dora::Size {
		return crate::dora::Size::from(unsafe { application_get_visual_size() });
	}
	pub fn get_device_ratio() -> f32 {
		return unsafe { application_get_device_ratio() };
	}
	pub fn get_platform() -> String {
		return crate::dora::to_string(unsafe { application_get_platform() });
	}
	pub fn get_version() -> String {
		return crate::dora::to_string(unsafe { application_get_version() });
	}
	pub fn get_deps() -> String {
		return crate::dora::to_string(unsafe { application_get_deps() });
	}
