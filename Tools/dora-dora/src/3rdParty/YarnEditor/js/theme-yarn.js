...
export function registerYarnTheme(ace) {
	ace.define('ace/theme/yarn', ['require', 'exports', 'module', 'ace/lib/dom'], function(require, exports) {
		exports.isDark = false;
		exports.cssClass = 'ace-yarn';
		exports.cssText = yarnThemeCss;
