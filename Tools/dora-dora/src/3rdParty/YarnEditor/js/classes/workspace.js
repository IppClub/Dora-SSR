...
export const Workspace = function(app) {
	...
	this.warpToXY = function(x, y) {
		...
		const winXCenter = $(window).width() / 2 - nodeWidth;
		const winYCenter = $(window).height() / 2 - nodeHeight;
