...
export interface reference_ImFont extends Emscripten.EmscriptenClassReference {
    ...
    CalcTextSizeA(size: number, max_width: number, wrap_width: number, text_begin: string, remaining: ImScalar<number> | null, isready:ImScalar<boolean>|null, out: interface_ImVec2): interface_ImVec2;
...
export interface reference_ImGuiWindow extends Emscripten.EmscriptenClassReference {
    ...
    SizeFull: reference_ImVec2;
    ContentSize: reference_ImVec2;
    ContentSizeIdeal: reference_ImVec2;
    ContentSizeExplicit: reference_ImVec2;
    WindowPadding: reference_ImVec2;
    WindowRounding:number;
    WindowBorderSize:number;
    Scroll: reference_ImVec2;
    ScrollMax: reference_ImVec2;
    ScrollTarget: reference_ImVec2;
    ScrollTargetCenterRatio: reference_ImVec2;
    ScrollTargetEdgeSnapDist: reference_ImVec2;
    ScrollbarSizes: reference_ImVec2;
    ScrollbarX:boolean;
    ScrollbarY:boolean;
    Active:boolean;
    WasActive:boolean;
